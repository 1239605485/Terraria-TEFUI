...
static const char *g_dependencies[] = {
    "eternal.future.tefui.api"
};

static const module_info_t g_info = {
    .pkg_id = "eternal.future.tefui.runtime",
    .name = "TEFUI Runtime",
    ...
    .plugin_dependencies = g_dependencies
};

static bool module_initialize(module_entry_t *entry) {
    (void)entry;
...
static bool module_cleanup(module_entry_t *entry) {
    (void)entry;
...
static void module_hot_reload(module_entry_t *entry) {
    (void)entry;
}

static const module_info_t *module_get_info(void) {
    return &g_info;
}

static const module_ops_t g_ops = {
    .init_module = module_initialize,
    .cleanup_module = module_cleanup,
    .hot_reload = module_hot_reload,
